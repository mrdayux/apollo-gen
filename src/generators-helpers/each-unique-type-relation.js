function eachUniqueTypeRelation(fieldsArray, options) {
    ...
    for (var i = 0; i < fieldsArray.length; i++) {
        ...
        if (entry.directives && entry.directives.relation) {
            var uniqueKey = entry.directives && entry.directives.relation && entry.type;
...
module.exports = eachUniqueTypeRelation;
